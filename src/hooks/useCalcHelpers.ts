...
export function openPrintWindow(title: string, bodyHtml: string): void {
  ...
  w.document.write('<div class="footer">FinCalci — Free Calculator App for India • fincalci.vercel.app<br>This report is for informational purposes only. Not financial advice.</div>');
